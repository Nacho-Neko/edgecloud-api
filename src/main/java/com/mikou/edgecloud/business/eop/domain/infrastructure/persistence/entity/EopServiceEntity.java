package com.mikou.edgecloud.business.eop.domain.infrastructure.persistence.entity;
...
public class EopServiceEntity {
    ...
    @TableField("status")
    private BusinessStatus status; // ACTIVE / SUSPENDED / EXPIRED
    ...
    public EopServiceEntity setStatus(BusinessStatus status) { this.status = status; return this; }
