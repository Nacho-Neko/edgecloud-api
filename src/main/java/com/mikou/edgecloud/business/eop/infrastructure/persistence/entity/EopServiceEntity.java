package com.mikou.edgecloud.business.eop.infrastructure.persistence.entity;
...
public class EopServiceEntity {
    ...
    @TableField("status")
    private ProductStatus status; // ACTIVE / SUSPENDED / EXPIRED
    ...
    public EopServiceEntity setStatus(ProductStatus status) { this.status = status; return this; }
